    ...
    <div className="sticky top-0 bg-black">
      <div className="flex-row flex justify-between gap-4 p-4 ">
        ...
        <div className="button gap-2 relative inline-flex align-middle ">
          <button className="pt-2 pb-2 pl-10 pr-10  hover:bg-gradient-to-br from-violet-500 to-pink-100 bg-gray-500 hover:bg-rgb(53 34 75) border-r-gray-500 rounded-3xl text-md uppercase">
            Let's talk
          </button>
