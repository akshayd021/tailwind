...
const Blog = () => {
  return (
    <div className="container lg:px-[5rem] md:px-[3rem] px-[15px] mx-auto">
      ...
      <div className="block md:flex flex-row justify-between mt-10 gap-6">
        ...
        <div className="lg:w-1/4 md:w-full p-6 w-full mt-5 lg:mt-0 rounded-xl bg-gray-400 border-b-4 border-violet-900 hover:bg-pink-300">
          <p>TAGS:</p>
